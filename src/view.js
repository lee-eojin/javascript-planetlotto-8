...
const OutputView = {
  ...
  printResult(countByRank) {
    ...
    MissionUtils.Console.print(`4개 일치, 보너스 번호 일치 (10,000,000원) - ${getCount(2)}개`);
    MissionUtils.Console.print(`4개 일치 (1,500,000원) - ${getCount(3)}개`);
    MissionUtils.Console.print(`3개 일치, 보너스 번호 일치 (500,000원) - ${getCount(4)}개`);
    MissionUtils.Console.print(`2개 일치, 보너스 번호 일치 (5,000원) - ${getCount(5)}개`);
